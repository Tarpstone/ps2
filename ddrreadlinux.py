...
ddrmax2usout = open("/home/annuitydew/ps2/static/DDRMAX2USout.csv",'w')
ddrmax2us = open("/home/annuitydew/ps2/static/ddrmax2us20190425",'rb')
max2w = csv.writer(ddrmax2usout,delimiter=',')
y = 0
...
while y <= -1: #24108
    ...
    print(str(y) + ': ' + str(i) + ' full, ' + str(j) + ' first half, ' + str(k) + ' second half')
    max2w.writerow([str(y),str(i),str(j),str(k)])
    y = y + 4

ddrex2usout = open("/home/annuitydew/ps2/static/EXTREME2USout.csv",'w')
ddrex2us = open("/home/annuitydew/ps2/static/extreme2us20190419",'rb')
ex2w = csv.writer(ddrex2usout,delimiter=',')
y = 0
